...
<div class="form-horizontal" role="form">
    <div >
        <div class="form-group clear my_form-group" style="padding-left: 20px;">
            <label class="control-label">家居工厂手机端轮播广告：</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-3">
                            <form id="carouselAction${c_index}" name="upfile"  method="post" enctype="multipart/form-data">
                                <div id="carouselPreview${c_index}" class="ps-image" style=" width:160px; height: 224px;  border:1px solid #CCC; background:url(${(c.showPicUrl)!'/aw/img/add_img.png'}) no-repeat;background-size:100% 100%">
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <label style="font-weight:100;font-size:8px;width:100%; text-align: left;">←点击左侧文件框上传图片, 图片大小为1M之内, 建议宽*高为400*586或1:1.46</label>
                        </div>
                        <div class="col-md-4 col-sm-4">
...
<script type="text/javascript">
                ...
                $("#carouselAction"+size).ajaxSubmit({
                    ...
                    success: function(data) {
                        if(data.state=='SUCCESS'){
                            ...
                            $.post('/manage/webSetting/insertCarousel',{gotoUrl:gotoUrl, picUrl:picUrl1, type:"5", typeName:"家具工厂内轮播图", title:title},function (res) {
                                if(res.count ==1){
                                }else{
    ...
    var addIndexImg = {
        addIndeximg:function(c_index){
            ...
            html +=" <div id='carouselPreview"+c_index+"' class='ps-image' style='height:224px;width:160px; border:1px solid #CCC; background:url("+imgUrl+") no-repeat;background-size:100% 100%'>";
            ...
            html +=" <label style='font-weight:100;font-size:8px;width:100%; text-align: left;'>←点击左侧文件框上传图片, 图片大小为1M之内, 建议宽*高为400*586或1:1.46</label></div>";

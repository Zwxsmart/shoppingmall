...
(function ($) {
    ...
    BootstrapTable.prototype.initData = function (data, type) {
        if (type === 'append') {
            var my = JSON.stringify(data);  //新增
            this.data = this.data.concat(JSON.parse(my)); //二次改写
            //this.data.push(JSON.parse(my)); //一次改写
            //this.data = this.data.concat(data); //原框架写法
        } else if (type === 'prepend') {
            var my = JSON.stringify(data); //新增
            this.data = [].concat(JSON.parse(my)).concat(this.data); //二次改写
            //this.data.unshift(JSON.parse(my)); //一次改写
            //this.data = [].concat(data).concat(this.data);  //原框架写法
        } else {
        ...
        if (type === 'append') {
            var my = JSON.stringify(data); //新增
            this.options.data = this.options.data.concat(JSON.parse(my)); //二次改写
            //this.options.data.push(JSON.parse(my)); //一次改写
            //this.options.data = this.options.data.concat(data); //原框架写法
        } else if (type === 'prepend') {
            var my = JSON.stringify(data); //新增
            this.options.data = [].concat(JSON.parse(my)).concat(this.options.data); //二次改写
            //this.options.data.unshift(JSON.parse(my));  //一次改写
            //this.options.data = [].concat(data).concat(this.options.data); //原框架写法
        } else {

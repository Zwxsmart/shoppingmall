...
import com.lanwantec.manage.utils.SecuritySessionUtils;
...
public class PathFormat {
    ...
    private static String getString(String pattern) {
        ...
        } else if (pattern.indexOf(PathFormat.BRAND) != -1) {
            return PathFormat.getBrand();
    ...
    private static String getBrand() {
        return SecuritySessionUtils.getBrandNo();
    }

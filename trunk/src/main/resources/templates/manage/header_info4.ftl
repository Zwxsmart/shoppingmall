...
<div class="form-horizontal" role="form">
    <div >
        <div class="form-group clear my_form-group" style="padding-left: 20px;">
            <label class="control-label">家博城手机端轮播广告：</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-3">
                            <form id="carouselAction${c_index}" name="upfile"  method="post" enctype="multipart/form-data">
                                <div id="carouselPreview${c_index}" class="ps-image" style="height:224px;width:160px;border:1px solid #CCC; background:url(${(c.showPicUrl)!'/aw/img/add_img.png'}) no-repeat;background-size:100% 100%">
                ...
                $("#carouselAction"+size).ajaxSubmit({
                    ...
                    success: function(data) {
                        if(data.state=='SUCCESS'){
                            ...
                            $.post('/manage/webSetting/insertCarousel',{gotoUrl:gotoUrl, picUrl:picUrl1, type:"7", typeName:"家博城手机端", title:title},function (res) {
                                if(res.count ==1){
                                }else{
